...
namespace PocketVes
{
	...
	public class Settings
	{
		...
		private string	m_settingsFileName	= "PocketVes.config";	// Имя файла с настройками
		
		private string	m_areaName		= "Участок []";
		private string	m_areaDescr		= "";
		private string	m_profName		= "Профиль";
		private string	m_profDescr		= "";
		private bool	m_profTypeProfil = true;		// true, если тип профиля profil, иначе тип curves
		private string	m_curveName		= "ВЭЗ";
		private string	m_curveDescr	= "";
		...
		private string	m_x				= "0";
		private string	m_y				= "0";
		private string	m_z				= "0";
		...
		private DataTable m_samplesTable;	// Таблица отсчетов
		...
		/// false - тип curves
		/// </summary>
		public bool ProfilType
		{
			get
			{
				return m_profTypeProfil;
			}
			set
			{
				m_profTypeProfil = value;
			}
		}
		/// <summary>
		/// Описание профиля
		/// </summary>
		public string ProfilDescr
		{
			get
			{
				return m_profDescr;
