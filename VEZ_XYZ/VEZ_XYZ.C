...
/* для последующей передачи в  программу GRID пакета SURFER*/
/* Программа GRID создает матрицы на регулярной сетке, по  */
/* которым можно строить вертикальные карты сопротивлений  */
/*---------------------------------------------------------*/
/* Project  : vez_xyz.c                                    */
/* Model    : small                                        */
/* Library  :                                              */
